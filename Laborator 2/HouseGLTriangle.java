...
public class HouseGLTriangle extends JFrame implements GLEventListener
{
		...
		gl.glBegin (GL2.GL_TRIANGLES);
			...
			gl.glBegin(GL.GL_TRIANGLE_FAN);
				...
				for(int i=0; i <= triangles; i++){
			         double x = radius * Math.cos(i * twicePi / triangles);
			         double y = radius * Math.sin(i * twicePi / triangles);
